...
# Populate with all committee names, with committee id as value
                                    ...
                                    <p class="formnote">Note: Common House policy only allows reserving rooms for non-committee use up to one month in advance.</p>
                                </td>  
                                <td>&nbsp;&nbsp;</td>
                                <td>
                                    <?php
...
// configure calendar theme
                                    initQCalendar('twocolumn', $dbConnect, 'qCalendarTwoColumn', $cssCalendar, 'myContentTwoColumn', $cssLongDesc, 0, $month, $year, $cat_id, 0);
                                    ?>
                                </td>
